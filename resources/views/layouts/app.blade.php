            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><div class="gradient-button"><a id="modal_trigger" href="{{route('register.index')}}"><i class="fa fa-sign-in-alt"></i> ثبت نام</a></div></li>
                        <li><div class="gradient-button"><a id="modal_trigger" href="{{route('register.login')}}"><i class="fa fa-sign-in-alt"></i>ورود</a></div></li>
                        @if(\Illuminate\Support\Facades\Auth::check())
                            <li><div class="gradient-button"><a id="modal_trigger" href=""><i class="fa fa-sign-in-alt"></i>خروج</a></div></li>
                        @endif
